...
**Companion files:**
- `reference/SYSTEM_REQUIREMENTS.md` — engineering detail: the sizing derivation, the mathematical model (§2.1), and the single-GPU training assessment
